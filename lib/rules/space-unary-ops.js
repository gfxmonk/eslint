...
module.exports = function(context) {
    ...
    */
    ...
    /**
    * Checks if the token is a word (as opposed to punctuation)
    * @param {string} value value of AST token
    * @returns {boolean} Whether the token is a word
    */
    function isWordExpression(value) {
